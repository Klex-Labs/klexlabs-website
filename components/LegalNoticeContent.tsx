      ...
      <>
        ...
        <section>
          ...
          <p>
            ...
            auf diesen Seiten verantwortlich. Wir sind jedoch nicht verpflichtet,
        ...
        <section>
          ...
          <p>
            Diese Website kann Links zu externen Websites enthalten. Auf deren Inhalte
            haben wir keinen Einfluss. Deshalb übernehmen wir für diese fremden Inhalte
  ...
  return (
    <>
      ...
      <section>
        ...
        <p>Kimi Kempe, address as stated above.</p>
      </section>
      ...
      <section>
        ...
        <p>
          This website may contain links to external websites. We have no influence over
          the content of those websites and therefore cannot assume liability for external
      ...
      <section>
        <h2>Copyright</h2>
        <p>
          The content and works created by the website operator on this website are subject
          to German copyright law. Reproduction, editing, distribution, or any form of use
          beyond the limits of copyright law requires written permission.
        </p>
      </section>
    </>
  );
